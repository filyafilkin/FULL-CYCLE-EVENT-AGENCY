<template>
  <div class="logo">
    <router-link :to="'/'">
      <svg id="logo" width="100%" viewBox="0 0 85 46"  xmlns="http://www.w3.org/2000/svg">
        <defs>
          <linearGradient id="bottom-to-top" radientUnits="userSpaceOnUse" x1="100%" y1="100%" x2="0" y2="0" gradientTransform="rotate(45)">
